...
/**
 * Dibujo del personaje Pollen con eventos (ChoiceBox).
 * 
 * @author Brandon Alexis Prado Castro (19051178)
 * @version 2.0. 20.09.2021
 */
public class PollenChoiceBox extends Application {
    @Override
    public void start(Stage primaryStage) {
        ...
        primaryStage.show();
        //ChoiceBox
        ChoiceBox cB1 = new ChoiceBox(FXCollections.observableArrayList("Mostrar pollen original", "Ocultar pollen", "Cambiar el color a rojo",
                "Cambiar el color a verde aqua", "Cambiar el color a morado", "Salir"));
        //Posicion del ChoiceBox
        cB1.setLayoutX(10);
        cB1.setLayoutY(10);
        //Acciones de las 6 opciones del ChoiceBx
        cB1.getSelectionModel().selectedIndexProperty().addListener((ObservableValue < ? extends Number > oV, Number oldVal, Number newVal) -> {
            if(newVal.intValue() == 0){
                draw(gc, Color.rgb(229, 166, 29));
            }else if(newVal.intValue() == 1){
                ocultar(gc);
            }else if(newVal.intValue() == 2){
                draw(gc, Color.rgb(148, 49, 38));
            }else if(newVal.intValue() == 3){
                draw(gc, Color.rgb(23, 165, 137));    
            }else if(newVal.intValue() == 4){
                draw(gc, Color.rgb(165, 105, 189));    
            }else if(newVal.intValue() == 5){
                System.exit(0);
            }
         });
        //Agregar el ChoiceBox a la ventana
    ...
    private void ocultar(GraphicsContext gc){
        ...
        gc.setFill(Color.rgb(238, 124, 90));
