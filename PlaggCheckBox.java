...
/**
 * Dibujo del personaje Plagg con Eventos (CheckBox).
 * 
 * @author Brandon Alexis Prado Castro (19051178)
 * @version 2.0. 19.09.2021
 */
public class PlaggCheckBox extends Application {
    @Override
    public void start(Stage primaryStage) {
        ...
        //CheckBox
        CheckBox ckB1 = new CheckBox("Mostrar Tikki original");
        CheckBox ckB2 = new CheckBox("Ocultar dibujo");
        CheckBox ckB3 = new CheckBox("Cambiar color a azul");
        CheckBox ckB4=  new CheckBox("Cambiar color a amarillo");
        CheckBox ckB5 = new CheckBox("Cambiar color a verde");
        CheckBox ckB6 = new CheckBox("Salir");
        //Default esta oculto
        ckB2.setSelected(true);
        //Mover CheckBox en forma vertical
        //cb1.setTranslateX(0);
        ckB2.setTranslateX(0);
        ckB2.setTranslateY(20);
        ckB3.setTranslateX(0);
        ckB3.setTranslateY(40);
        ckB4.setTranslateX(0);
        ckB4.setTranslateY(60);
        ckB5.setTranslateX(0);
        ckB5.setTranslateY(80);
        ckB6.setTranslateX(0);
        ckB6.setTranslateY(480);
        
        ckB1.setOnAction((ActionEvent event) -> {
            draw(gc, Color.rgb(13, 31, 38));//Color original
        });
        ckB2.setOnAction((ActionEvent event) -> {
            ocultar(gc);
        });
        ckB3.setOnAction((ActionEvent event) -> {
            draw(gc, Color.rgb(36, 104, 106));
        });   
        ckB4.setOnAction((ActionEvent event) -> {
            draw(gc, Color.rgb(223, 181, 49));
        });
        ckB5.setOnAction((ActionEvent event) -> {
            draw(gc, Color.rgb(28, 222, 128 ));
        });
        ckB6.setOnAction((ActionEvent event) -> {
            System.exit(0);
        });
        
        root.getChildren().add(ckB1);
        root.getChildren().add(ckB2);
        root.getChildren().add(ckB3);
        root.getChildren().add(ckB4);
        root.getChildren().add(ckB5);
        root.getChildren().add(ckB6);
    }
    ...
    private void ocultar(GraphicsContext gc){
        ...
        gc.setFill(Color.rgb(84, 150, 175));
